...
<div class="w3-container w3-padding w3-display-middle w3-half w3-border w3-border-red ">
	...
	<div class="w3-text-white w3-border-bottom w3-border-white">
		<p>Display Picture:</p>
		<p class="w3-center "><a href="#"><img src="https://upload.wikimedia.org/wikipedia/commons/7/72/Default-welcomer.png" class="w3-circle w3-image w3-border w3-border-white w3-margin w3-hover-sepia" style="width:100%;max-width:200px; height:200px" alt=""></a></p>
	</div>
	<div class="w3-text-white w3-border-bottom w3-border-white">
